...
export default function Owner() {
    ...
    const [newProduct, setNewProduct] = useState({ p_name: "",p_desc:"",price:"",quantity:"",image:"",alt:""});
                        ...
                        {categories ? (
                                    categories.map((category, index) => (
                                        ...
                                        className={`grid grid-cols-1 gap-1 py-3 even:bg-gray-50 sm:grid-cols-4 sm:gap-4 cursor-pointer ${
                                            selectedCategory === category.Category_ID ? 'border border-blue-500' : '' // Apply border for selected categories
                                        }`}
                                        >
                ...
                <div className="flow-root">
                        ...
                        {brands ? (
                                    brands.map((brand, index) => (
                                        ...
                                        className={`grid grid-cols-1 gap-1 py-3 even:bg-gray-50 sm:grid-cols-4 sm:gap-4 cursor-pointer ${
                                            selectedBrand === brand.Brand_ID ? 'border border-blue-500' : '' // Apply border for selected categories
                                        }`}
                                        >
                ...
                <div className="flow-root">
                        ...
                        {vendors ? (
                                    vendors.map((vendor, index) => (
                                        ...
                                        className={`grid grid-cols-1 gap-1 py-3 even:bg-gray-50 sm:grid-cols-3 sm:gap-4 cursor-pointer ${
                                            selectedVendor === vendor.Vendor_ID ? 'border border-blue-500' : '' // Apply border for selected categories
                                        }`}
                                        >
                ...
                <div className="flow-root">
                        ...
                        {products ? (
                                    products.map((product, index) => (
                                        ...
                                        className={`grid grid-cols-1 gap-1 py-3  sm:grid-cols-3 sm:gap-4 cursor-pointer ${product.Product_Stock===1?'bg-red-600':'even:bg-gray-50'} ${
                                            selectedProduct === product.Product_Id ? 'border border-blue-500' : '' // Apply border for selected categories
                                        }`}
                                        >
